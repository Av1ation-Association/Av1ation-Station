...
export type APIFunction<SDKFunction> = SDKFunction extends (_event: infer E extends IpcMainInvokeEvent, ...params: infer Parameters) => infer SDKFunctionReturn ? (...params: Parameters) => Promise<SDKFunctionReturn> : never;
